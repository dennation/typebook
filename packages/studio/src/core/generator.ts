...
import { PACKAGE_NAME, DEFAULT_REGISTRY_FILE, META_FILENAME } from '../constants.js'
...
/**
 * Generate the content of studio.meta.gen.ts — extracted component metadata.
...
export function generateMetaFile(
  ...
  const lines: string[] = [
    `// ${META_FILENAME} — auto-generated by @dennation/${PACKAGE_NAME}, do not edit`,
...
/**
 * Generate the content of studio.registry.gen.ts — imports stories, configs, and meta.
 */
