					...
					<table className="st:w-full st:text-xs">
						<thead>
							<tr className="st:border-b st:border-border">
								<th className="st:text-left st:py-1.5 st:px-3 st:font-semibold st:text-text-muted">
									Prop
								</th>
								<th className="st:text-left st:py-1.5 st:px-3 st:font-semibold st:text-text-muted">
									Type
						...
						<tbody>
							{props.map((prop) => (
								...
								>
									...
									<td
										className="st:py-1.5 st:px-3 st:font-mono st:text-text-muted st:max-w-[200px] st:truncate"
