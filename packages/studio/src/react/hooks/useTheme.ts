...
export function useTheme(override?: Theme): {
	...
	const systemTheme = useSyncExternalStore(subscribeToSystemTheme, getSystemTheme, () => 'light' as Theme)

	const [userTheme, setUserTheme] = useState<Theme | null>(() => override ?? getStoredTheme())
