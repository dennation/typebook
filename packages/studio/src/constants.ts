...
/** Default glob pattern for .docs.tsx files */
export const DEFAULT_DOCS_GLOB = './src/**/*.docs.tsx'
...
/** Default page name for auto-generated component API page */
export const DEFAULT_DOCS_PAGE = 'API'
