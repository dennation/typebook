...
import type { ComponentHandle, RegisterConfigOmit, RegisterConfigPick } from './types.js'
...
): ComponentHandle<Simplify<Omit<Props, Omitted>>, Exclude<keyof Defaults & keyof Props, Omitted>>
