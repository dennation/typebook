...
const VARIANTS: Record<ButtonVariant, string> = {
	primary: 'bg-accent text-accent-fg shadow-sm hover:bg-accent-hover hover:shadow-md',
...
export const ARROW_CLASS = 'transition-transform duration-[160ms] group-hover:translate-x-[3px]'
...
type ButtonAsButton = CommonProps & { as?: 'button' } & Omit<ButtonHTMLAttributes<HTMLButtonElement>, 'children'>
type ButtonAsAnchor = CommonProps & { as: 'a' } & Omit<AnchorHTMLAttributes<HTMLAnchorElement>, 'children'>
