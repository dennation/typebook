...
export function Matrix<Props extends object, Defaulted extends keyof Props = never>(
	...
	return <MatrixTable xLabels={xLabels} rows={rows} render={render} isolate={isolate} />
}
