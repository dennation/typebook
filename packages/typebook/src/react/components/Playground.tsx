...
export function Playground({ of: config }: { of: Registration<any> }) {
	const { Component, propInfos: allProps, defaultProps } = useRegistration(config)

	const [controlProps, setControlProps] = useState<Record<string, unknown>>(defaultProps)
