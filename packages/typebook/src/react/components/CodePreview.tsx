...
const DEFAULT_THEME: CodeTheme = { light: 'github-light', dark: 'github-dark' }
...
function getHighlighter(themes: CodeTheme): Promise<any> {
...
export function CodePreview({ code, theme = DEFAULT_THEME }: CodePreviewProps) {
