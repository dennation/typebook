      ...
      shared/                       — Reusable primitives
        ...
        ui/{accordion,callout,cards,md-table,props-reference,steps,tabs,prose,headings}/
                                      — the Markdown/MDX content set, one folder per component
                                        ...
                                        Tabs, Steps (compound Steps.Root + Steps.Step), Accordion, Cards/DocCard, prose (Lead/C/A/
                                        ImgPlaceholder — only behavior/prop-carrying elements; plain p/ul/ol/li/blockquote/hr are
                                        bare tags styled by the .doc-prose layer), headings (H2/H3)
