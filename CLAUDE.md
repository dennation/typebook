      ...
      shared/                       — Reusable primitives
        ...
        ui/{accordion,callout,cards,md-table,props-reference,steps,tabs,prose,headings}/
                                      — the Markdown/MDX content set, one folder per component
                                        ...
                                        (Paragraph/Lead/List/ListItem/Blockquote/Divider/Strong/Emphasis/InlineCode/Link/
                                        ImagePlaceholder — every prose element is a component carrying its own styles; there is
