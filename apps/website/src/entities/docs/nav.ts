...
export const COMPONENTS = defineMenu<DocsMeta | undefined>({
	...
	"/docs/components/headings": { title: "Headings" },
	"/docs/components/lead": { title: "Lead" },
	"/docs/components/inline-code": { title: "Inline code" },
	"/docs/components/link": { title: "Link" },
	"/docs/components/image-placeholder": { title: "Image placeholder" },
...
export const SEARCH_INDEX: SearchEntry[] = [
	...
	},
	{
		...
		section: "Rendering stories",
		heading: "interactive-props",
	...
	{
		slug: "components/headings",
		title: "Headings",
		section: "Components",
		desc: "Anchored section/subsection titles with TOC hooks",
	},
	{
		slug: "components/lead",
		title: "Lead",
		section: "Components",
		desc: "Large muted intro paragraph under the page title",
	},
	{
		slug: "components/inline-code",
		title: "Inline code",
		section: "Components",
		desc: "C — inline monospace fragments in running text",
	},
	{
		slug: "components/link",
		title: "Link",
		section: "Components",
		desc: "A — accent inline link with href or in-app onClick",
	},
	{
		slug: "components/image-placeholder",
		title: "Image placeholder",
		section: "Components",
		desc: "ImgPlaceholder — hatched stand-in for pending art",
	},
	{
