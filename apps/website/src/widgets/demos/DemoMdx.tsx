...
export function DemoMdx() {
	return (
		<div className={DEMO_FRAME}>
			...
			<div className="pt-10 px-6.5 pb-6.5 h-full flex flex-col justify-center">
				<div className="border border-border rounded-t-[10px] border-b-0 bg-code-bg px-4 py-3.5 font-mono text-[12px] leading-[1.7]">
					<div>
						<span className="text-fg-subtle mr-3 opacity-50">1</span>
					...
					<div>
						<span className="text-fg-subtle mr-3 opacity-50">2</span>
						&nbsp;&nbsp;This runs on the client only.
					</div>
					<div>
						<span className="text-fg-subtle mr-3 opacity-50">3</span>
						<span className="tok-punc">&lt;/</span>
						<span className="tok-tag">Callout</span>
						<span className="tok-punc">&gt;</span>
					</div>
				</div>
				<div className="border border-dashed border-border-strong border-t-0 rounded-b-[10px] p-4 grid place-items-center min-h-30">
