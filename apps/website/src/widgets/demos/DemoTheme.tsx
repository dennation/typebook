...
const CARD = 'absolute inset-0 rounded-[12px] border p-[20px] flex flex-col gap-[12px] shadow-md'
	...
	return (
		<div className={cx(DEMO_FRAME, 'grid place-items-center p-[28px]')}>
			...
			<div className="relative w-full max-w-[320px] aspect-[1.45]">
				...
				>
					<div className="text-[14px] font-[650] tracking-[-0.02em] [color:oklch(0.2_0.012_270)]">Acme Docs</div>
					<div className={cx(BAR, 'w-[90%] [background:oklch(0.92_0.01_270)]')} />
					<div className={cx(BAR, 'w-[62%] [background:oklch(0.92_0.01_270)]')} />
					<div className={cx(BAR, 'w-[74%] [background:oklch(0.92_0.01_270)]')} />
				...
				>
					<div className="text-[14px] font-[650] tracking-[-0.02em] [color:oklch(0.95_0.004_270)]">Acme Docs</div>
					<div className={cx(BAR, 'w-[90%] [background:oklch(0.3_0.01_270)]')} />
					<div className={cx(BAR, 'w-[62%] [background:oklch(0.3_0.01_270)]')} />
					<div className={cx(BAR, 'w-[74%] [background:oklch(0.3_0.01_270)]')} />
					<div className={CHIP}>Get started</div>
				</div>
			</div>
		</div>
