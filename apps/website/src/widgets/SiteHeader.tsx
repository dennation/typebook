...
import { ARROW_CLASS, Icon, ThemeToggle, buttonClass, cx } from '@dennation/typebook/react'
...
export function SiteHeader({ docsHref = '#', githubHref = '#', version = 'v2.4' }: SiteHeaderProps) {
	...
	return (
		...
		>
			<a className="flex items-center gap-[10px] font-semibold tracking-[-0.02em] text-[15px]" href="#top">
			...
			<div className="flex items-center gap-[6px]">
				...
				<a className={cx(buttonClass('primary', 'sm'), 'ml-[4px]')} href={docsHref}>
